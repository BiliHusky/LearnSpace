...
public class OpenReplicatorTest {
    ...
    private static final String host = "11.11.54.33";//"localhost";
    private static final int port = 13307;//3306;
    private static final String user = "root";
    private static final String password ="passw0rd";// "qazwsx123";

    public static void main(String[] args){
        OpenReplicator or = new OpenReplicator ();
        or = new OpenReplicatorPlus();
        or.setUser(user);
