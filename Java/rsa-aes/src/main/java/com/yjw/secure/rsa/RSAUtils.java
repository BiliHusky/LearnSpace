package com.yjw.secure.rsa;

import com.yjw.secure.Base64Utils;
...
//        getKeys();
        String encryptData=RSAUtils.encryptByPublicKey("secret");
        System.out.println(encryptData);
        System.out.println(RSAUtils.decryptByPrivateKey(encryptData));
        int a=655555;
